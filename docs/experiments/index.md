...
| --- | --- | --- |
| 2026-05-19 | [Tensor Layout Qualification](tensor-layout-qualification-2026-05-19.md) | fresh-workspace artifact qualification end to end |
| 2026-05-20 | [Claude Code Runner](claude-code-runner-2026-05-20.md) | the `claude` headless runner, MCP activation, replay |
| 2026-05-23 | [Claude MCP Telemetry](claude-mcp-tool-telemetry-2026-05-23.md) | machine-readable evidence that Claude actually *called* generated tools |
| 2026-05-24 | [CPU MoE Real Smoke](cpu-moe-real-smoke-2026-05-24.md) | the compiled top-2 MoE kernel task path |
| 2026-05-26 | [H100 Triton RMSNorm](h100-triton-rmsnorm-2026-05-26.md) | real H100-over-SSH scoring, 150.0 → 103.3 µs |
| 2026-05-27 | [H100 Triton RMSNorm (Long)](h100-triton-rmsnorm-long-2026-05-27.md) | longer run from a generated bundle, 17 active tools, 142.8 → 99.7 µs |
