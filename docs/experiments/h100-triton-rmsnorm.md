...
```text
tmp/h100_triton_real/.harnessgym/runs/<run-id>/
```
...
```bash
python3 tmp/h100_triton_real/.harnessgym/mcp/h100_triton_rmsnorm/server.py \
  --workspace tmp/h100_triton_real \
  --self-test

python3 tmp/h100_triton_real/.harnessgym/tests/test_h100_triton_mcp.py
```
